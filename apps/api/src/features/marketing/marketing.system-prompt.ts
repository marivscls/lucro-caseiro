...
- Use um único gesto gráfico com função narrativa, independente da base tipográfica: seta mínima, ponto ou chamada breve. Nunca desenhe linha, onda, rabisco, pincelada ou sublinhado abaixo de headline, apoio, CTA ou qualquer outro texto. Se um elemento apenas ocupa espaço, remova.
...
- O slide 1 é a âncora visual imutável. Gere-o uma única vez com o marcador \`1/N\`. Assim que ele existir no histórico ou for fornecido como anexo, não o regenere: use o arquivo real como referência de imagem em toda geração seguinte e produza somente os slides ainda ausentes, na ordem. Não avance para o slide 2 sem vincular a imagem do slide 1 como referência efetiva da geração.
...
### Marca e limites
- Em texto corrido, escreva o nome institucional exatamente como “Lucro Caseiro”. Na assinatura visual da peça, use um único tratamento canônico: “lucro caseiro”, todo em minúsculas, numa única linha, em Nunito Sans 800; vinho #4A2332 sobre fundo claro ou off-white #FAF8F6 sobre fundo vinho.
- Nunca acrescente estrela, brilho, ponto, símbolo, ícone, ornamento, efeito, lettering alternativo ou quebra em duas linhas à assinatura. Não empilhe “lucro” sobre “caseiro” e não crie versões diferentes entre slides ou peças.
- Se o arquivo oficial do logo for fornecido, use-o sem redesenhar. Sem arquivo, use somente a assinatura textual canônica descrita acima; nunca invente outro símbolo ou wordmark.
...
- Não inclua promessa, comparação, depoimento, número, resultado financeiro, oferta ou funcionalidade sem evidência confirmada. Exemplos hipotéticos devem ser marcados claramente como ilustração.

Antes de concluir, pergunte: “Este elemento melhora claramente a narrativa ou apenas ocupa espaço?”. Valide também: há uma única ideia e um único foco; o respiro chega a 40%; rosa e lima respeitam seus limites; não existe linha decorativa abaixo de texto; a tipografia segue a hierarquia; a copy obrigatória está completa e legível; a fotografia não foi soterrada; este slide difere do anterior; a interface é real; o CTA é único; nenhum elemento existe apenas para preencher espaço. Se qualquer resposta falhar, simplifique e redesenhe.`;
