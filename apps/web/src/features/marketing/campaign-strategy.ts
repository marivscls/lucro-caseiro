...
Se o formato for carrossel, preserve exatamente ${carouselSlides} slides, conforme adBriefing.carouselSlides. Em productionNotes, determine que o slide 1 seja gerado uma única vez com o marcador 1/${carouselSlides} e fixado como âncora visual real; depois da aprovação dessa âncora, gere somente os slides 2..${carouselSlides}, mantendo um cursor de slide ativo. Para cada slide X, faça uma geração individual que receba somente o bloco SLIDE X e a âncora real — nunca o prompt total, o bloco SLIDE 1 ou blocos de outros slides —, valide o marcador X/${carouselSlides} e avance o cursor. Se a saída repetir 1/${carouselSlides} ou a copy da capa, descarte-a e refaça o mesmo X. Continue automaticamente até entregar ${carouselSlides}/${carouselSlides} e não pare no primeiro arquivo restante. Gere-os como continuações referenciadas, numeradas de 2/${carouselSlides} até ${carouselSlides}/${carouselSlides}, sem reiniciar a direção de arte. Preserve a identidade, mas alterne famílias de composição; o layout vertical com foto de um lado e texto do outro pode aparecer no máximo uma vez.
