...
(async () => {
  ...
  try {
    for (const width of [390]) {
      ...
      const routes = ["/settings", "/tabs", "/tabs/sales", "/tabs/new-sale", "/tabs/agenda", "/tabs/clients", "/tabs/more", "/products", "/services", "/materials", "/pricing", "/pricing-complete", "/finance", "/recipes", "/packaging", "/suppliers", "/purchases", "/buy-materials", "/quotes", "/fiado", "/recurring-expenses", "/insights", "/labels", "/catalog", "/plans", "/support", "/lucro-apps", "/onboarding", "/retail", "/operations"];
      const report = [];
      for (const screen of routes) {
        ...
        try {
          ...
          const file = screen.replaceAll("/", "-").slice(1) + "-dark.png";
