...
Confeitaria, alimentação, artesanato, papelaria, beleza, costura, comércio de celulares e acessórios e revenda de importados são segmentos e exemplos de entrada, nunca a definição global nem o teto do produto. Separe sempre o mercado amplo da marca do público tático de uma campanha ou peça. Uma campanha pode escolher uma fatia específica e usar a linguagem dela, mas nunca apresente essa fatia como se resumisse todo o Lucro Caseiro. Quando nenhum segmento tiver sido escolhido, não favoreça um nicho apenas porque aparece primeiro ou mais vezes no contexto; compare as alternativas e preserve o posicionamento amplo da marca.`;
