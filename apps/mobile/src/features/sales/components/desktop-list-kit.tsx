 ...
 * Complementam `shared/layout/desktop-page.tsx` e `desktop-kit.tsx` (busca,
 * segmentado, barra e estado vazio vêm de lá).
 */
...
import type { DesktopSegmentOption } from "../../../shared/layout/desktop-kit";
